          ...
          <ul className="pl-8 space-y-4 mt-2">
            ...
            <li>
              ...
              {isExamSectionOpen && (
                <ul className="pl-4 space-y-2">
                  <li>
                    <NavLink to="/grade" className="flex items-center text-sm text-white hover:text-gray-400">
                      <span>Add Grade</span>
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="/exam" className="flex items-center text-sm text-white hover:text-gray-400">
                      <span>Add Exam</span>
                    </NavLink>
                  </li>
                   <li>
